...
\solution
\item Find the number of elements in the element table for $t$.
\solution 
\solution The nuber of elements is 
\item Let $\vec{r}$ be the received codeword (noisy). $r(x)$ is then defined to be the received polynomial.
\item 
